...
export function IngredientSafety() {
    return (
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="lg:w-1/2">
                        <span className="text-mint font-bold tracking-wider uppercase mb-2 block">Safety First</span>
                        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-deep-purple">
                            Know what's safe in <span className="text-ultraviolet">seconds</span>.
                        </h2>
                        <p className="text-xl text-deep-purple/70 mb-8 leading-relaxed">
                            No more guessing. Freshies uses advanced AI to analyze ingredient lists instantly, giving you a clear 0-100 score and highlighting potential irritants or risks.
                        </p>

    ...
    return (
        <section {...storyblokEditable(blok)} className="py-24 bg-deep-purple text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                {/* Content Wrapper with Flexible Order */}
                <div className="flex flex-col gap-16">

                    {/* 1. Top Tabs (Grid of Cards) */}
                    <div className={cn(
                        "grid md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-7xl mx-auto w-full",
                        blok.layout === 'preview_top' ? "order-2" : "order-1"
                    )}>
                    ...
                    <div className={cn(
                        "relative min-h-[500px] overflow-hidden rounded-[2.5rem] bg-white border border-white/20 shadow-2xl p-8 md:p-12 lg:p-16 transition-all duration-500",
                        blok.layout === 'preview_top' ? "order-1" : "order-2"
                    )}>
                        {features.map((feature: any, index: number) => {
